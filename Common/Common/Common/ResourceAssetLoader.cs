...
namespace Common 
{
    ...
    /// </summary>
    public class ResourceAssetLoader : IResourceLoader
    {
        ...
        public override T LoadAsset<T>(string fileName)
        {
            ...
            if (null != info.dependencies)
            {
                ...
                {
                    AssetBundle.LoadFromFile(FileUtils.GetPath(dep));
                }
            }
        ...
        public override string LoadText(string fileName)
        {
            ...
            TextAsset bindata = asset.LoadAsset(info.assetName) as TextAsset;
            return bindata.text;
        }
    }
}
